...
const addCourtInDb = async (name, description, priceFee, warrantyReservation, grassType, lighting, doorsType, wallsType, reputation, horarioInicio, imgClub, horarioCierre, SportId, LocationId, ClubId) => {
    try {
        const addCourt = await Court.findOrCreate({ 
            where:{name},
            defaults: {name, description, priceFee, warrantyReservation, grassType, lighting, doorsType, wallsType, reputation, horarioInicio, imgClub, horarioCierre, SportId, LocationId, ClubId}
        })
